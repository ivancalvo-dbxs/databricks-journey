...
4. Click on "Create external location"
...
5. Select the AWS QuickStart and click on "Next"
...
6. Fill the bucket name and click on "Generate new token": s3://`<existing-bucket-name>` and copy the tokan
...
<br />
7. Paste the token in the "Databricks Personal Access Token" field and click on "I acknowledge that aws cloud formation might create iam resources with custom names" and click on create stack
