...
* Configure the Databricks Account, Unity Catalog and Workspace.
* Run mandatory configurations.

## Outcome

* The Databricks setup follows the best practices.
...
<img src={useBaseUrl('/img/account-users.png')} alt="description"/>


#### Groups

Extended explanation on: [Identity best practices
