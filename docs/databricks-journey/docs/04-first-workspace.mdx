...
# Create the first Databricks Workspace
...
To easily accomplish this task, use Terraform. Databricks offers multiple Terraform examples and modules in a public repository.

From the repo: [Terraform Databricks Examples](https://github.com/databricks/terraform-databricks-examples/tree/main/examples)

These are the recommended modules to start:
...
This approach can lead to missing configurations and is highly prone to errors if you miss one step.
:::
