...
Then, proceed to: [**Cloud object storage**](./cloud-object-storage/index.mdx).
...
Then, follow this section: [**External databases or warehouses**](./external-systems/index.mdx).
